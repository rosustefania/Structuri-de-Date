...
typedef enum{
	...
	WEARHOUSE_CREATE,
	WEARHOUSE_EMPTY_FULL,
	WEARHOUSE_PACKAGE_PRIORITY,
	WEARHOUSE_DESTROY,

	ROBOT_CREATE,
	ROBOT_EMPTY_FULL,
	ROBOT_GET_PRIO_PACKAGE,
...
int main(int argc, char** argv){
	if(argc < 4){
		fprintf(stderr, "USAGE: %s <wearhouse file path> <parkinglot file path> <output file path> <test_number>\n",argv[0]);
		exit(1);
	}
